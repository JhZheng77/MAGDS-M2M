...
FilePath: /SDN-WIFI/ryu/arp_handler.py
Date: 2023-07-14 16:07:11
Description: 
            算法流程
            packet_in
                |
...
class ArpHandler(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        """
            ...
            1. arp包 是否已经记录
        """
        # print("handler---> _packet_in_handler: PacketIn")
        msg = ev.msg
        ...
        # print("handler---> _packet_in_handler: pkt:\n  ", pkt)
        ...
        # print("handler--->_packet_in_handler: header_list:\n    ", header_list)
        if isinstance(arp_pkt, arp.arp):
            ...
            if self.arp_handler(header_list, datapath, in_port, msg.buffer_id):
                ...
                # print("handler--->zzzzzz----> location", location)
                if location:  # 如果有这个主机的位置
                    # print("handler--->_packet_in_handler: ==Reply Arp to knew host")
                    ...
                    # print("handler--->_packet_in_handler: == dpid  {}  Flooding  arp_dst_ip  {}".format(datapath.id,arp_dst_ip))
        ...
        if ARP in header_list:
            ...
            if opcode == arp.ARP_REQUEST:
                if arp_dst_ip in self.arp_table:  # arp reply
                    # print("handler---> arp_handler: ====ARP REPLY")
